...
const Testimonials = () => {
  const data = [
    ...
    },
    {
      ...
      desc:
        " My interests lies in Web Development and Data Science. Learning Blockchain and web dev during the past few months and looking forward to enhance my skills under the same. I have gained knowledge in C++, AI Ml, Web Dev - HTML, CSS, JAVA and 
        Blockchain like solidity, ethers library till now.",
    },
  ];
  return (
