...
const Testimonials = () => {
  ...
  useEffect(()=>{
    ...
    if (link===1) {
      <a href="https://www.instagram.com/subram_das/"></a>
    }
    
    if (link===2) {
      <a href="https://www.linkedin.com/in/subram-das-09b755235"></a>
    }
    
    if (link===3) {
      <a href="https://www.youtube.com/@luciferiitbombay5307/videos"></a>
    }
  ...
  return (
    ...
    {data.map((d)=>(
      ...
      <div className={d.featured? "card featured" :"card"} onClick={()=>setLink(d.id) console.log(setLink)1}>
        <div className="top">
